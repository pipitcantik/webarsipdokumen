...
<section id="bidang" class="bidang">
  ...
  <?php if ($row["file_pdf"] == "" || $row["file_pdf"] == null): ?>
    <a href="upload_pdf.php?id=<?= $row['id_arsip_dokumen']; ?>" class="btn btn-sm btn-success">
      Upload PDF
    </a>
  <?php else: ?>
    <a href="upload/<?= $row['file_pdf']; ?>" target="_blank" class="btn btn-sm btn-info">
      Lihat PDF
    </a>
  <?php endif; ?>
</td>
...
<div class="footer">
	COPYRIGHT &copy; <?= date('Y'); ?> PT. MATRA ENGINEERING AND CONTRUCTIONS
</div>
